...
class AddPlayerViewController: UIViewController {
    ...
    @IBAction func addPlayerBtnAction(_ sender: Any) {
        ...
        let player = Players.init(name: tempName, money: 10000, House: "", isMarried: false, child: 0, color: tempColor, insurance: [insurancePlayer](), isFinish: false, isCollege: false, floor: 0)
